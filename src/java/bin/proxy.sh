...
java -Dlog4j.configuration=lib/log4j-proxy.properties -Dxtrace.reporter="edu.berkeley.xtrace.reporting.TcpReporter" -Dxtrace.tcpdest="${1}:7831" -cp $CLASSPATH edu.berkeley.xtrace.server.XTraceProxy
